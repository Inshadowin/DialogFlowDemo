$(document).ready(function () {
  var navListItems = $('div.setup-panel div a'),
   spriteItems = $('div.setup-panel div a span'),
  ...
  navListItems.click(function (e) {
      ...
      if (!$item.hasClass('disabled')) {
          ...
          spriteItems.removeClass();
          spriteItems.addClass('sprite');
          for(var i=0;i<spriteItems.length;i++){
                if(i<id){
                  $(spriteItems[i]).addClass('q-wizard_complete');
                }else if (i > id){
                  $(spriteItems[i]).addClass('q-wizard_next');
                }
          }
